...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">E-Babul<sup></sup></div>
            </a>
    ...
    <script src="{{asset('templateadmin/admin')}}/vendor/jquery/jquery.min.js"></script>
    <script src="{{asset('templateadmin/admin')}}/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="{{asset('templateadmidn/admin')}}/vendor/jquery-easing/jquery.easing.min.js"></script>
